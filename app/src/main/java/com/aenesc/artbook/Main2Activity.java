...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artNameText = findViewById(R.id.editTextArtName);
        painterNameText = findViewById(R.id.editTextPainter);
        ...
        if (info.matches("new")) {
            ...
            Bitmap selectImage = BitmapFactory.decodeResource(getApplicationContext().getResources(), R.drawable.artbook);
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    ...
                    Bitmap bitmap = BitmapFactory.decodeByteArray(bytes, 0, bytes.length); // bytes dizisini görsel hale getiren kod
...
//        finish(); //activiteyi bitirip bir önceki activiteye döndürür.
    }

    // imageların boyutunu düşür.
